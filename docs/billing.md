...
4. An owned storefront is billable: false, and every marketplace is billable: true. This is
   ...
   as a marketplace; decision 23 says why. Polar, built at B13, is seeded billable too, and
   provisionally: it is external and not the creator's own store, but it is a checkout with
   no marketplace behind it, and decision 32 asks whether that earns the marketplace price.
