...
- Unit, database and integration tests as `docs/listing-import.md` §14 lists them; journey 14.
...
**B12's exit test** is journey 14, with one clause that carries it: the listing must be one
