...
export interface ChannelBrandMark {
  ...
  path: string
  /**
   * Further paths drawn in the same fill, for a mark its owner publishes as
   * several overlapping shapes rather than one. Each is painted on its own,
   * so the overlaps stay solid; folded into `path` under `evenodd` they would
   * punch holes where the shapes cross.
   */
  paths?: readonly string[]
  /** The fill rule the owner's own SVG uses. simple-icons marks are all nonzero. */
...
export const CHANNEL_MARKS: Partial<Record<ChannelKey, ChannelBrandMark>> = {
  ...
  */
  ...
  /*
    Not from simple-icons, which has no Polar mark. From Polar's own brand
    assets, `clients/apps/web/src/components/Brand/logos/LogoIcon.tsx` in the
    Apache-2.0 polarsource/polar repository, scaled from its 29 box to 24 and
    kept as the three even-odd rings it is drawn with. "Night" is the brand
    black on Polar's brand page.
  */
  polar: {
    hex: "#090909",
    fillRule: "evenodd",
    path: "M7.512 19.082C11.485 21.771 16.887 20.731 19.576 16.758C22.266 12.784 21.225 7.383 17.252 4.694C13.279 2.004 7.877 3.045 5.188 7.018C2.498 10.991 3.539 16.392 7.512 19.082ZM8.665 19.153C12.3 21.012 16.91 19.267 18.963 15.254C21.016 11.242 19.734 6.482 16.099 4.622C12.465 2.763 7.854 4.508 5.801 8.521C3.748 12.533 5.031 17.293 8.665 19.153Z",
    paths: [
      "M9.701 20.102C12.982 21.17 16.841 18.349 18.322 13.801C19.802 9.254 18.342 4.702 15.061 3.634C11.78 2.566 7.921 5.387 6.441 9.934C4.961 14.482 6.42 19.034 9.701 20.102ZM10.705 19.756C13.481 20.348 16.483 17.305 17.41 12.96C18.337 8.614 16.838 4.611 14.061 4.019C11.285 3.426 8.282 6.469 7.356 10.815C6.429 15.161 7.928 19.164 10.705 19.756Z",
      "M11.465 20.473C13.66 20.707 15.851 17.046 16.358 12.295C16.866 7.544 15.497 3.502 13.302 3.268C11.107 3.034 8.916 6.695 8.409 11.446C7.902 16.197 9.27 20.239 11.465 20.473ZM12.493 19.027C14.081 19.002 15.319 15.786 15.256 11.843C15.194 7.901 13.856 4.726 12.267 4.751C10.679 4.776 9.441 7.992 9.503 11.934C9.566 15.876 10.904 19.052 12.493 19.027Z",
    ],
  },
  etsy: {
    hex: "#F16521",
